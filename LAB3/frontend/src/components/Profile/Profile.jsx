  ...
  onSubmit(e) {
    ...
    this.props.client
      ...
      .then(response => {
        ...
        this.setState({
          userData: response.data.updateProfile.userData,
          name: response.data.updateProfile.userData.name,
          email: response.data.updateProfile.userData.email,
          phone: response.data.updateProfile.userData.phone,
          city: response.data.updateProfile.userData.city,
          country: response.data.updateProfile.userData.country,
          homeTown: response.data.updateProfile.userData.homeTown,
          school: response.data.updateProfile.userData.school,
          company: response.data.updateProfile.userData.company,
          languages: response.data.updateProfile.userData.languages,
          gender: response.data.updateProfile.userData.gender,
          about: response.data.updateProfile.userData.about
        });
      });
